...
MPICH_CMD = config['scgui'].get('mpich_cmd', '/usr/lib64/mpich-3.2/bin/mpiexec')
MPICH_ARGS = config['scgui'].get('mpich_args', '-n 2')
FDISTDUMP_CMD = config['scgui'].get('fdistdump_cmd', 'fdistdump')
FDISTDUMP_HA_CMD = config['scgui'].get('fdistdump_ha_cmd', 'fdistdump_ha')
